...
class opParams:
  def __init__(self):
    ...
    self.default_params = {'awareness_factor': {'default': 10., 'allowed_types': [float, int], 'description': 'Multiplier for the awareness times', 'live': False},
                           ...
                           'steer_max1': {'default': 225, 'allowed_types': [float, int], 'description': 'Steer Max to use in carcontroller.py', 'live': False},
                           'steer_max2': {'default': 245, 'allowed_types': [float, int], 'description': 'Steer Max to use in carcontroller.py', 'live': False},
                           ...
                           'lqr_scale': {'default': 1600.0, 'allowed_types': [float, int], 'description': 'LQR Scale to use in interface.py', 'live': False},
                           'lqr_ki': {'default': 0.04, 'allowed_types': [float, int], 'description': 'LQR Ki to use in interface.py', 'live': False},
