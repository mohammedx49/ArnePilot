...
class opParams:
  def __init__(self):
    ...
    self.default_params = {'awareness_factor': {'default': 10., 'allowed_types': [float, int], 'description': 'Multiplier for the awareness times', 'live': False},
                           ...
                           'steer_max1': {'default': 180, 'allowed_types': [float, int], 'description': 'Steer Max to use in carcontroller.py', 'live': False},
                           'steer_max2': {'default': 200, 'allowed_types': [float, int], 'description': 'Steer Max to use in carcontroller.py', 'live': False},
                           'steer_max3': {'default': 230, 'allowed_types': [float, int], 'description': 'Steer Max to use in carcontroller.py', 'live': False},
                           'steer_ratio': {'default': 13.2, 'allowed_types': [float, int], 'description': 'Steer ratio to use in interface.py', 'live': False},
