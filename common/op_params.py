...
class opParams:
  def __init__(self):
    ...
    self.default_params = {'awareness_factor': {'default': 10., 'allowed_types': [float, int], 'description': 'Multiplier for the awareness times', 'live': False},
                           'alca_min_speed': {'default': 15, 'allowed_types': [float, int], 'description': 'Speed limit to start ALC in MPH', 'live': False},
                           ...
                           'dynamic_follow': {'default': 'far', 'allowed_types': [str],
                           ...
                           'steer_max1': {'default': 230, 'allowed_types': [float, int], 'description': 'Steer Max to use in carcontroller.py', 'live': False},
                           'steer_max2': {'default': 250, 'allowed_types': [float, int], 'description': 'Steer Max to use in carcontroller.py', 'live': False},
                           'steer_max3': {'default': 270, 'allowed_types': [float, int], 'description': 'Steer Max to use in carcontroller.py', 'live': False},
                           'steer_ratio': {'default': 12.0, 'allowed_types': [float], 'description': 'Steer ratio to use in pathplanner.py', 'live': True},
                           ...
                           'lqr_scale': {'default': 1500.0, 'allowed_types': [float], 'description': 'LQR Scale to use in latcontrol_lqr.py', 'live': True},
                           'lqr_ki': {'default': 0.05, 'allowed_types': [float], 'description': 'LQR Ki to use in latcontrol_lqr.py', 'live': True},
                           'indi_olg': {'default': 15.0, 'allowed_types': [float, int], 'description': 'INDI OuterLoopGain to use in interface.py', 'live': False},
                           'indi_ilg': {'default': 6.0, 'allowed_types': [float, int], 'description': 'INDI InnerLoopGain to use in interface.py', 'live': False},
                           'indi_time': {'default': 5.5, 'allowed_types': [float, int], 'description': 'INDI TimeConstant to use in interface.py', 'live': False},
                           'indi_act': {'default': 6.0, 'allowed_types': [float, int], 'description': 'INDI ActuatorEffectiveness to use in interface.py', 'live': False},
